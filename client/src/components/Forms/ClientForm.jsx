...
const ClientForm = ({ entryForm }) => {
  ...
  const { form, response, errors, handleBlur, handleChange, handleSubmit } =
    useFormClient(entryForm, validateFormClient);

  return (
    <div className="form-client-box bg-warning">
      <h2 className="title-form-client">Formulario Cliente</h2>
